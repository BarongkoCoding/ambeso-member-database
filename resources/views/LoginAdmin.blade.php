...
<head>
  ...
  {{-- <style>
    body {
    background-image: url("{{ asset('AmbesoLP/images/slide-image01.jpg') }}");
    }
  </style> --}}
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('adminfrontend') }}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Admin Ambeso </b>Member</a>
    </div>
    <div class="card-body">
...
<!-- AdminLTE App -->
<script src="{{ asset('adminfrontend') }}/dist/js/adminlte.min.js"></script>
</body>
</html>
