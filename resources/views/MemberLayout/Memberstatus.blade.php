...
-->
	<!-- stylesheet css -->
	<link rel="stylesheet" href="{{ asset('MemberTamplate') }}/css/bootstrap.min.css">
	<link rel="stylesheet" href="{{ asset('MemberTamplate') }}/css/font-awesome.min.css">
	<link rel="stylesheet" href="{{ asset('MemberTamplate') }}/css/templatemo-gray.css">
</head>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<img src="{{ asset('MemberTamplate') }}/images/member.png" class="img-responsive img-circle tm-border" alt="templatemo easy profile">
				<hr>
...
<!-- javascript js -->	
<script src="{{ asset('MemberTamplate') }}/js/jquery.js"></script>
<script src="{{ asset('MemberTamplate') }}/js/bootstrap.min.js"></script>	
<script src="{{ asset('MemberTamplate') }}/js/jquery.backstretch.min.js"></script>
<script src="{{ asset('MemberTamplate') }}/js/custom.js"></script>
